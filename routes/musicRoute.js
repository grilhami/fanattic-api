...
const { 
    ...
    deleteGenre, createSubgenre } = require('../controllers/musicController');
...
router.put('/genres/:genreId', authMiddleware, updateGenre);
router.delete('/genres/:genreId', authMiddleware, deleteGenre);
